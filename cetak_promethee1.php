...
if($seleksi!="") {	
?>
<p style="margin-bottom:10px; color:#333;">Alternatif dengan nilai Leaving Flow (LF) paling besar merupakan alternatif terbaik, dan alternatif dengan nilai entering Flow (EF) paling kecil adalah alternatif terbaik berdasarkan nilai EF. Jika ranking antara LF dan EF tidak sama maka dilanjutkan ke tahap Promethee II</p>
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
