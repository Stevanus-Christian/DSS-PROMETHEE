...
if($seleksi!="") {	
?>
<p style="margin-bottom:10px; color:#333;">Alternatif dengan nilai Net Flow (NF) paling besar merupakan alternatif terbaik.</p>
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    <th width="34" style="vertical-align:middle;">No.</th>
    <th width="132" style="vertical-align:middle;">NISN</th>
    <th width="251" style="vertical-align:middle;">Nama Lengkap</th>
