<?php
	...
	{
		mysqli_query($db, "INSERT INTO alternatif_kriteria(id_alternatif, id_kriteria, id_alternatif_kriteria, nilai) VALUES('$_POST[id_alternatif]', '$_POST[id_kriteria]','$_POST[id_alternatif_kriteria]', '$_POST[nilai]')");
