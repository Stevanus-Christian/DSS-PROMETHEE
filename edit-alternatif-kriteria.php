<?php
	...
	{
		mysqli_query($db, "UPDATE alternatif_kriteria SET id_alternatif='$_POST[id_alternatif]', id_kriteria='$_POST[id_kriteria]', id='$_POST[id_alternatif_kriteria]', nilai='$_POST[nilai]' WHERE id_alternatif_kriteria = '$_POST[id_alternatif_kriteria]'");
