...
<table width="100%" border="0" cellpadding="0" cellspacing="0" >
  <tr>
    ...
    <th width="61%">Tipe Preferensi</th>
    <th width="61%">Nilai Min (Q)</th>
    <th width="61%">Nilai Max (P)</th>
	<script type="text/javascript">
    function konTambah() {
            window.location = "?page=kriteria-input&act=tambah";
    }
    </script>
...
function konfirmasi<?php echo $dataquery[0]; ?>() {
  ...
  <tr>
	...
	elseif($dataquery['tipe_preferensi']==5) { echo "Kriteria Linear &amp; area tdk berbeda"; } 
	?>
    </td>
    <td><?php echo"$dataquery[nilai_q]"; ?></td>
    <td><?php echo"$dataquery[nilai_p]"; ?></td>
    <td align="center">
    <a href="?page=kriteria-input&act=edit&id=<?php echo"$dataquery[0]"; ?>">
