<h1>Data Seleksi Anternatif Metode PROMETHEE</h1>
<?php 
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="82%"><input name="proses_hitung" type="submit" value="Proses PROMETHEE" class="tombol"/></td>
  </tr>
</table>
</form>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    ...
    <th width="74" rowspan="2" style="vertical-align:middle;">Kode</th>
    <th width="162" rowspan="2" style="vertical-align:middle;">Alternatif</th>
  ...
  <tr>
    ...
    <div style="text-align:center;">
		...
		elseif($dk['tipe_preferensi']==5) { echo "Kriteria Linear &amp; area tdk berbeda"; } 
...
//Tampilkan Nilai yang sudah diinputkan beserta data kriteria
$qk="SELECT a.id_alternatif, a.kode, a.alternatif, c.id_seleksi_alternatif FROM alternatif as a, seleksi_alternatif as c
		 WHERE a.id_alternatif=c.id_alternatif AND c.id_seleksi='$seleksi' ORDER BY c.id_seleksi_alternatif ASC";
$hk=$koneksi->query($qk);
$jmlkkolom=mysqli_num_rows($hk);
?>
...
<table width="100%" border="0" cellspacing="0" cellpadding="4">
  <tr>
    ...
    <th width="162" style="vertical-align:middle;">Alternatif</th>
    <?php 
		while($dk=mysqli_fetch_array($hk)){
	?>
...
<?php
$no=0;
$queryX="SELECT a.id_alternatif, a.kode, a.alternatif, c.id_seleksi_alternatif, d.nilai_lf, d.nilai_ef, d.nilai_nf FROM alternatif as a, seleksi_alternatif as c, hasil_akhir as d
...
?>
  <tr>
    ...
    <?php
		$urut=0;
		$qk2="SELECT a.id_alternatif, a.kode, a.alternatif, c.id_seleksi_alternatif FROM alternatif as a, seleksi_alternatif as c
		 WHERE a.id_alternatif=c.id_alternatif AND c.id_seleksi='$seleksi' ORDER BY c.id_seleksi_alternatif ASC";
		$hk2=$koneksi->query($qk2);
		while($dk2=mysqli_fetch_array($hk2)){
			$urut=$urut+1;
...
<?php } ?>
    <tr>
      <td colspan="3">
      <form action="?page=seleksi-rank" method="post" enctype="multipart/form-data">
      <input type="hidden" name="seleksi" value="<?php echo"$seleksi"; ?>" />
      <input type="submit" name="btn_next" value="Selanjutnya (Hasil Ranking)" class="tombol2">
      </form>
      </td>
      <td colspan="<?php echo $jmlkkolom; ?>"><?php if($stat=="ok") { ?> <span style="font-size:14px; color:#0066CC; font-weight:bold;"><?php echo "Data berhasil disimpan."; ?></span><?php } ?> </td>
    </tr>
