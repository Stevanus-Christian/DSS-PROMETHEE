                        ...
                        <h1 class="mt-4 mb-5">Data Alternatif Kriteria</h1>
                            <table class="table table-bordered">
                                ...
                                <?php
                                    ...
                                    $queryalternatifkriteria = mysqli_query($db, "SELECT * FROM alternatif_kriteria ORDER BY id_alternatif_kriteria, id_alternatif, id_kriteria ASC");
                                    while ($dataalternatifkriteria = mysqli_fetch_array($queryalternatifkriteria))
                                    {
                                        ...
                                        $querysubkriteria = mysqli_query($db, "SELECT * FROM alternatif_kriteria WHERE id_alternatif_kriteria = '$dataalternatifkriteria[id_alternatif_kriteria]'");
